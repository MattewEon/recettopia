...
const TOURTE_ROQUEFORT: RecipeCard = recipe({
  ...
  groups: [
    ingredients([
      ['Pâtes feuilletées', '2'],
      ['Pommes de terre Rosa', '8'],
      ['Roquefort', '250 g'],
      ['Lardons fumés', 'selon goût'],
      ['Champignons de Paris', 'selon goût'],
      ['Oignons', '2'],
      ['Crème fraîche', '3 càs'],
      ['Vin blanc', 'un verre'],
      ['Sel, poivre, muscade', 'q.s.'],
      ["Jaune d'œuf (dorure)", '1'],
    ]),
    steps([
...
const FLAN_POIREAU_SAUMON: RecipeCard = recipe({
  ...
  groups: [
    ingredients([
      ...
      ['Saumon frais', '200 g'],
      ['Œufs', '4'],
      ['Crème de coco ou végétale', '200 ml'],
...
const FLAN_THON_TOMATES_ORIGAN: RecipeCard = recipe({
  ...
  groups: [
    ingredients([
      ...
      ['Œufs', '4'],
      ['Crème végétale ou classique', '200 ml'],
      ["Huile d'olive", 'q.s.'],
      ['Origan', 'q.s.'],
      ['Ail (optionnel)', '1 gousse'],
      ['Sel, poivre', 'q.s.'],
      ['Olives noires (optionnel)', 'quelques-unes'],
...
const PITA_POULET_BLAISE: RecipeCard = recipe({
  ...
  groups: [
    ingredients([
      ...
      ['Oignons', 'selon goût'],
      ['Poivrons', 'selon goût'],
      ['Chorizo en dés', 'selon goût'],
      ['Lardons fumés', 'selon goût'],
      ["Épices à l'espagnole", 'q.s.'],
      ['Crème liquide', '25 cl'],
      ['Gruyère râpé', '1 sachet'],
      ['Pains pita', 'selon convives'],
    ]),
    steps([
      [
        'Cuire',
...
const HARICOTS_BLANCS_TOMATE: RecipeCard = recipe({
  ...
  groups: [
    ingredients([
      ...
      ['Oignon', 'un peu'],
      ['Ail, persil, sel, poivre', 'q.s.'],
      ['Vin blanc', '¼ verre'],
      ['Beurre', '~100 g'],
      ['Crème fraîche + Vache qui rit', 'en fin'],
...
const CURRY_PATATES_POISSON: RecipeCard = recipe({
  ...
  groups: [
    ingredients([
      ...
      ['Jus de citron', 'q.s.'],
      ['Curry, ail, sel, poivre', 'q.s.'],
      ['Safran, cumin, coriandre, piment', 'q.s.'],
    ]),
    steps([
      [
        'Wok',
...
const RISOTTO_CURRY_COCO: RecipeCard = recipe({
  ...
  groups: [
    ingredients([
      ...
      ['Lait de coco', '~300 ml'],
      ['Lait + eau (cuisson)', 'q.s.'],
      ['Curry, piment de Cayenne', 'selon goût'],
      ['Fines herbes, sel, huile', 'q.s.'],
    ]),
    steps([
...
const GRATIN_PDT_CHORIZO: RecipeCard = recipe({
  ...
  groups: [
    ingredients([
      ...
      ['Chorizo ou jambon tranché fin', 'selon goût'],
      ['Fromage à gratiner', 'q.s.'],
      ['Œufs, crème, lait', 'q.s.'],
      ['Sel, poivre, fines herbes', 'q.s.'],
    ]),
    steps([
